        ...
        {bookings.length === 0 ? (
          <Card className="border border-border rounded-2xl bg-card">
            <CardContent className="py-12 text-center">
              ...
              <Link href="/booking">
                <Button className="bg-teal-500 hover:bg-teal-400 text-white rounded-full">Book a Court</Button>
              </Link>
            </CardContent>
          </Card>
        ) : (
              ...
              <CardContent>
                {upcomingBookings.length === 0 ? (
                  <div className="text-center py-6 text-muted-foreground">
                    ...
                    <Link href="/booking" className="text-teal-400 font-medium hover:underline text-sm">
                      Book a court
                    </Link>
                  </div>
                ) : (
