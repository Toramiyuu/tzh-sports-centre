...
export default function LessonsPage() {
  ...
  const renderLessonCard = (lesson: LessonTypeData) => {
    ...
    return (
      ...
      >
        <Card
          className={`relative h-full bg-background border cursor-pointer transition-colors duration-200 ${
            isPopular
        ...
        >
          {isPopular && (
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
              <Badge className="bg-primary text-white shadow-md shadow-primary/20">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${isPopular ? "bg-primary/15" : "bg-muted"}`}>
                  <Users className={`w-4 h-4 ${isPopular ? "text-primary" : "text-muted-foreground"}`} />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-xl">
              ...
              <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold font-display text-foreground tracking-tight leading-[1.1] mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-forwards">
                {t("title")}
              </h1>
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold font-display text-foreground mb-4">
              {t("packages.title")}
            </h2>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold font-display text-foreground mb-4 animate-in fade-in duration-700 fill-mode-forwards">
              {t("coach.title")}
            </h2>
