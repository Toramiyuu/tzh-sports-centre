        ...
        <div className="space-y-8">
          {updateLog.map((entry, index) => (
            <div key={entry.id} className="relative">
              ...
              {/* Update card */}
              <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5 ml-2 border-l-4 border-l-teal-500">
              ...
              {index < updateLog.length - 1 && (
                <div className="absolute left-5 top-full w-0.5 h-8 bg-gray-200" />
              )}
            </div>
          ))}
        </div>
