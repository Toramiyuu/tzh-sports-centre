  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:border-[#1854d6] border border-border shadow-xs has-focus:ring-[#1854d6]/50 has-focus:ring-[3px] rounded-md",
