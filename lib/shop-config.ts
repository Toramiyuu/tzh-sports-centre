...
export type ShopCategoryId = 'rackets' | 'shoes' | 'bags' | 'clothing' | 'grips' | 'accessories' | 'pickleball'
...
export const SHOP_PRODUCTS: ShopProduct[] = [
  // ==================== RACKETS ====================
  {
    ...
    price: 799,
    description: 'Professional-grade attacking racket with Rotational Generator System for maximum power.',
    specs: {
      'Weight': '4U (83g)',
      'Balance': 'Head Heavy',
      'Flex': 'Stiff',
  ...
  },
  {
    ...
    price: 650,
    description: 'High-end power racket used by professional players worldwide.',
    specs: {
      'Weight': '3U (85g)',
      'Balance': 'Head Heavy',
      'Flex': 'Stiff',
  ...
  },
  {
    ...
    price: 580,
    description: 'Balanced performance racket with excellent control and power.',
    specs: {
      'Weight': '4U (83g)',
  ...
  },
  {
    ...
    price: 280,
    description: 'Ultra-lightweight racket perfect for beginners and intermediate players.',
    specs: {
      'Weight': '5U (75g)',
  ...
  // ==================== BAGS ====================
  {
    ...
    price: 299,
    description: 'Large tournament bag with 3 main compartments, fits up to 9 rackets.',
    specs: {
      'Capacity': '9 Rackets',
  ...
  },
  {
    ...
    price: 180,
    description: 'Versatile racket bag with shoe compartment and padded straps.',
    specs: {
      'Capacity': '6 Rackets',
  ...
  // ==================== GRIPS ====================
  {
    ...
    price: 22,
    description: 'The most popular overgrip in the world. Excellent tackiness and absorbency.',
    specs: {
      'Type': 'Overgrip',
      'Thickness': '0.6mm',
      'Quantity': '3 pieces',
  ...
  },
  {
    ...
    price: 12,
    description: 'Durable overgrip with unique fishbone texture for enhanced grip.',
    specs: {
      'Type': 'Overgrip',
      'Thickness': '0.6mm',
      'Quantity': '1 piece',
  ...
  // ==================== ACCESSORIES ====================
  {
    ...
    price: 28,
    description: 'All-round string offering excellent durability and repulsion.',
    specs: {
      'Gauge': '0.70mm',
      'Length': '10m',
      'Type': 'Multifilament',
  ...
  // ==================== PICKLEBALL ====================
  {
    ...
    price: 399,
    description: 'Pro-level paddle designed with Ben Johns, featuring Carbon Friction Surface.',
    specs: {
